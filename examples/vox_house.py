...
g.add(grf.AlternativeSprites(
    vox.make_house_sprite(zoom=grf.ZOOM_NORMAL, xofs=-25, yofs=-33),
    vox.make_house_sprite(zoom=grf.ZOOM_2X, xofs=-25 * 2, yofs=-33 * 2),
    vox.make_house_sprite(zoom=grf.ZOOM_4X, xofs=-25 * 4, yofs=-33 * 4),
))

debug_sprites((
    (vox.make_house_sprite(zoom=grf.ZOOM_NORMAL, xofs=-25, yofs=-33), 4),
    (vox.make_house_sprite(zoom=grf.ZOOM_2X, xofs=-25 * 2, yofs=-33 * 2), 2),
    (vox.make_house_sprite(zoom=grf.ZOOM_4X, xofs=-25 * 4, yofs=-33 * 4), 1)),
    1)

g.write('grfpy_example_vox_house.grf')
